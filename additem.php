<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $additem = $item->store($iname, $idetails, $iquantity, $iprice);
                        ...
                        <form action="" method="post">
                            <div class="form-group pt-2 pl-2 pr-2">
                                ...
                                <div class="form group">
                                    ...
                                    <textarea cols="10" rows="10" class="form-control" name="itemdetails"></textarea>
                                </div>
                                <div class="form group">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary form-control">Add Item</button>
                            </div>
                        </form>
                    </div>
                </div>
